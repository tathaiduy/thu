 ...
 * @author tatha
 */
public class SearchCakeUserController extends HttpServlet {
private static final String ERROR = "error/error.jsp";
private static final String SUCCESS = "user/cake-user.jsp" ;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            request.setAttribute("USERCAKEINFO", result);
            url = SUCCESS;
            
        }
        catch(Exception e)
        {
            log("Error at SearchCakeUserController: "+e.getMessage());
        }
        finally
        {
