        ...
        <div class="site-wrap">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 text-center">
                            <form action="MainUserController" method="POST" id="loadWelcomeUserPage">
                                ...
                                <a href="javascript:welcomeUserPageAboutPage()" class="site-logo">
            ...
            <div class="site-section  pb-0">
                ...
                <div class="container">
                    ...
                    <div class="row mb-5">
                        <form action="MainUserController" class="col-md-12" method="post">
                            <div class="site-blocks-table">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                    <h2> There is no product in this cart </h2>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row mb-5">
                                <div class="col-md-6">
                                    <form action="MainUserController" method="POST">
                                        <button name="action" value="Cake" class="btn btn-outline-primary btn-md btn-block">Continue Shopping</button>
                                    </form>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <strong class="text-black"><%=shoppingCart.getTotal()%></strong>
                                        </div>
                                    </div>
                                    <div class="row mb-5">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="MainUserController" method="POST">
                                                <input type="submit" name="action"class="btn btn-primary btn-lg btn-block" value="Checkout" />
                                            </form>
