...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 text-center">
            <a href="welcome-user.html" class="site-logo">
          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                <li><a href="welcome-user.html" class="nav-link text-left">Home</a></li>
                <li><a href="about-user.html" class="nav-link text-left">About</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <form action="MainUserController" method="POST" id="thanksyou">
                <input type="hidden" name="action" value="Cake" />
                <p><a href="javascript:thankyou()" class="btn btn-md height-auto px-4 py-3 btn-primary">Back to store</a></p>
            </form>
  ...
  <script type="text/javascript">
      function thankyou()
      {
          document.getElementById('thanksyou').submit();
      }
  </script>
