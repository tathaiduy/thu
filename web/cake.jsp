  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 text-center">
            <a href="error.html" class="site-logo">
              ...
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                <li>
                  ...
                  <li>
                    ...
                    <input type="submit" value="Cart" class="btn add text-left" />
                  </form>
                  </li>
                  <span class="tab"></span>
              </ul>                                                                                                                                                                                                                                                                                         
    ...
    <div class="site-section mt-5">
      <div class="container">
        ...
        <div class="row">
<c:forEach items="${requestScope.INFOCAKE}" var="dto" varStatus="count">
                
    
        <div class="col-lg-4 mb-5 col-md-6">
<form action="AddCakeController" method="POST">
            <div class="wine_v_1 text-center pb-4">
                <a href="shop-single.html" class="thumbnail d-block mb-4"><img src=${dto.cakePicture} alt="Image" class="img-fluid"></a>
              <div>
                  <h3 class="heading mb-1" id="cakeName"><a href="#">${dto.cakeName}</a></h3>
