                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <form action="MainAdminController" method="POST" id="loadIndexPage">
                                                        <li class="nav-item">
                                                            <input type="hidden" name="txtProductList"value="index.jsp"/>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                                    ...
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom01">Cake Name</label>
                                                <input class="form-control" name="txtUpdateCakeName" class="mb-3"  id="validationCustom01" required="" type="text" placeholder="Cake Name" value="${requestScope.UPDATECAKEADMIN.cakeName}">
                                                <font color ="red" >
                                                <label class="text-danger">${requestScope.INVALIDCAKEUPDATE.cakeNameError}</label>
                                                </font>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom01">Cake Price</label>
                                                <input class="form-control" name="txtUpdateCakePrice" class="mb-3"  id="validationCustom01" required="" type="text" placeholder="Cake Price" value="${requestScope.UPDATECAKEADMIN.cakePrice}">
                                                <font color="red">
                                                <p class="text-danger" >${requestScope.INVALIDCAKEUPDATE.cakePriceError}</p>
                                                    </font>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-description">
                                            ...
                                            <input type="hidden" name="txtUpdateCakeID" value="${requestScope.UPDATECAKEADMIN.cakeID}" />
                                            <!--<input type="hidden" name="txtUpdateCakePicture" value="$--{requestScope.UPDATECAKEADMIN.cakePicture}" />-->
                                            <input type="hidden" name="action" value="Update Cake" />
                                                <a href="javascript:loadUpdate()" class="btn btn-primary btn-block btn-lg">Update Cake</a>
