                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>${counter.count}</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="${dto.cakePicture}" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>${dto.cakeName} </td>
                                                        <td>${dto.cakeID}</td>
                                                        
                                                        <td>${dto.cakePrice}VND </td>
                                                        
                                                        
                                                        <td><span class="badge-dot badge-brand mr-1"></span>Available</td>
                                                    </tr>
                                                    </c:forEach>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="country-sales list-group list-group-flush">
                                            <li class="country-sales-content list-group-item"><span class="mr-2"><i class="flag-icon flag-icon-vn" title="us" id="us"></i> </span>
                                                <span class="">Viet Nam</span><span class="float-right text-dark">78%</span>
                                            </li>
