            ...
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item">
                            <form action="SearchUserAdminController" method="POST">
                                <div id="custom-search" class="top-search-bar">
                                    <input class="form-control" type="text" placeholder="Search.." name="txtSearchUserAdmin">
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        ...
                        <c:forEach items="${requestScope.USERADMIN}" var="dto" varStatus="counter">
                        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                            <form action="MainAdminController" method="POST">
                                    <div class="product-thumbnail">
                                        ...
                                        <div class="product-content">
                                            <div class="product-content-head">
                                                <h3 class="product-title">${dto.fullname}</h3>
                                                ...
                                                <div class="product-price">${dto.role}</div>
                                            </div>
                                            <div class="product-btn">
                                                <!--<a href="#" class="btn btn-primary">Add to Cart</a>-->
                                                <!--<a href="#" class="btn btn-outline-light">View Details</a>-->
                                                <input type="hidden" name="txtEditName" value="${dto.username}" />
                                                <input type="hidden" name="txtEditFullName" value="${dto.fullname}" />
                                                <input type="hidden" name="txtEditRole" value="${dto.role}" />
                                                <input type="hidden" name="txtEditPhoneNumber" value="${dto.phonenumber}" />
                                                <input type="hidden" name="txtEditEmailAddress" value="${dto.email}" />
                                                <input type="hidden" name="txtDateOfBirth" value="${dto.dateOfBirth}" />
                                                <!--<input type="hidden" name="txtProductList" value="$--{dto.dateOfBirth}" />-->
                                                <input type="submit" class="btn btn-outline-light" value="View Details User" name="action"/>
                                                <input type="submit" class="btn btn-outline-danger" value="Delete User Admin" name="action"/>
