<%@page import="Cake.DTO.RegisterDTO"%>
<!doctype html>
<html lang="en">
    ...
    <body>
                            ...
                            <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="row">
                                            ...
                                            <div id="productslider-1" class="product-carousel carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="d-block" src="$--{requestScope.UPDATECAKEADMIN.cakePicture}" alt="First slide">
                                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                                        <form action="MainAdminController" method="POST" id="loadAdminUpdateController">
                                            <div class="product-details">
                                                <div class="border-bottom pb-3 mb-3">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">Username</label>
                                                        <input class="form-control" name="txtUpdateUsername" class="mb-3" readonly="readonly" id="validationCustom01" required="" type="text" placeholder="Username" value="${requestScope.EDITUSERADMIN.username}">
                                                        <font color ="red" >
                                                        <label class="text-danger">${requestScope.INVALIDUPDATEUSER.usernameError}</label>
                                                        </font>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">Fullname</label>
                                                        <input class="form-control" name="txtUpdateFullname" class="mb-3" readonly="readonly"  id="validationCustom01" required="" type="text" placeholder="Fullname" value="${requestScope.EDITUSERADMIN.fullname}">
                                                        <font color="red">
                                                        <p class="text-danger" >${requestScope.INVALIDUPDATEUSER.fullnameError}</p>
                                                        </font>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">Role</label>
                                                        <select name="txtUpdateRole" class="form-control"  id="input-select" >
                                                            <%
                                                                RegisterDTO dto = (RegisterDTO)request.getAttribute("EDITUSERADMIN");
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        ...
                                                        <input class="form-control" name="txtUpdatePhoneNumber" class="mb-3" readonly="readonly"  id="validationCustom01" required="" type="text" placeholder="Cake Price" value="${requestScope.EDITUSERADMIN.phonenumber}">
                                                        <font color="red">
                                                        <p class="text-danger" >${requestScope.INVALIDUPDATEUSER.phoneNumberError}</p>
                                                        </font>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">Email Address</label>
                                                        <input class="form-control" name="txtUpdateEmailAddress" class="mb-3" readonly="readonly" id="validationCustom01" required="" type="text" placeholder="Email" value="${requestScope.EDITUSERADMIN.email}">
                                                        <font color="red">
                                                        <p class="text-danger" >${requestScope.INVALIDUPDATEUSER.emailAddressError}</p>
                                                        </font>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                        <label for="validationCustom01">Date Of Birth</label>
                                                        <input class="form-control" name="txtUpdateDateOfBirth" class="mb-3" readonly="readonly" id="validationCustom01" required="" type="text" placeholder="Cake Price" value="${requestScope.EDITUSERADMIN.dateOfBirth}">
                                                        <font color="red">
                                                        <p class="text-danger" >${requestScope.INVALIDUPDATEUSER.dateOfBirthError}</p>
                                                        </font>
                                                    </div>     
                                                </div>
                                                <div class="product-description">
                                                    <h4 class="mb-1">Descriptions</h4>
                                                    <p>Chỉnh sữa xong nhớ update hộ cái</p>
                                                    <input type="hidden" name="action" value="Update User" />
                                                    <input type="hidden" name="txtUpdateCakeID" value="${requestScope.UPDATECAKEADMIN.username}" />
                                                    <!--<input type="hidden" name="txtUpdateCakePicture" value="$--{requestScope.UPDATECAKEADMIN.cakePicture}" />-->
                                                    <a href="javascript:loadUpdate()" class="btn btn-primary btn-block btn-lg">Update User</a>
        ...
        <script type="text/javascript">
            function loadUpdate()
            {
                document.getElementById('loadAdminUpdateController').submit();
            }
        </script>
