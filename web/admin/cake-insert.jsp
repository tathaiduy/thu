...
<head>
    ...
    <link rel="stylesheet" href="admin/assets/vendor/datepicker/tempusdominus-bootstrap-4.css" />
...
John Abraham</span>is now following you
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Insert New User</h2>
                ...
                <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h3 class="card-header">Insert New Cake</h3>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" action="InsertCakeAdminController" method="Post">
                                        <!--<div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Cake ID</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" placeholder="Cake ID" class="form-control" name="txtInsertCakeID">
                                            </div>
                                            <label class="text-danger">$--{requestScope.INSERTCAKEINVALID.cakeIDError}</label>
                                        </div>-->
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Cake Title</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" placeholder="Cake Name" class="form-control" name="txtInsertCakeName">
                                            </div>
                                            <label class="text-danger">${requestScope.INSERTCAKEINVALID.cakeNameError}</label>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Cake price</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-maxlength="200" placeholder="CakePrice" class="form-control" name="txtInsertCakePrice">
                                            </div>
                                            <label class="text-danger">${requestScope.INSERTCAKEINVALID.cakePriceError}</label>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Cake Picture</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" data-parsley-maxlength="200" placeholder="cake Picture" class="form-control" name="txtInsertCakePicture">
                                            </div>
                                            <label class="text-danger">${requestScope.INSERTCAKEINVALID.cakePictureError}</label>
                                        </div>
                                        <!--<div class="form-group row">
                                        ...
                                        <input type="hidden" name="txtProductList" value="cake-insert.jsp" />
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script src="admin/assets/vendor/datepicker/moment.js"></script>
    <script src="admin/assets/vendor/datepicker/tempusdominus-bootstrap-4.js"></script>
    <script src="admin/assets/vendor/datepicker/datepicker.js"></script>
