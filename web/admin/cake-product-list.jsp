            ...
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item">
                            <form action="SearchBookAdminController" method="POST">
                                <div id="custom-search" class="top-search-bar">
                                    <input class="form-control" type="text" placeholder="Search.." name="txtSearchCakeAdmin">
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        ...
                        <c:forEach items="${requestScope.INFOCAKEADMIN}" var="dto" varStatus="counter">
                                    ...
                                    <div class="product-thumbnail">
                                        <div class="product-img-head">
                                            <div class="product-img">
                                                <img src="${dto.cakePicture}" alt="" class="img-fluid"></div>
                                        ...
                                        <div class="product-content">
                                            <div class="product-content-head">
                                                <h3 class="product-title">${dto.cakeName}</h3>
                                                ...
                                                <div class="product-price">${dto.cakePrice}VND</div>
                                            </div>
                                            <div class="product-btn">
                                                <!--<a href="#" class="btn btn-primary">Add to Cart</a>-->
                                                <!--<a href="#" class="btn btn-outline-light">View Details</a>-->
                                                <input type="hidden" name="txtEditCakeID" value="${dto.cakeID}" />
                                                <input type="hidden" name="txtUpdateCakeName" value="${dto.cakeName}" />
                                                <input type="hidden" name="txtUpdateCakePrice" value="${dto.cakePrice}" />
                                                <input type="hidden" name="txtProductList" value="cake-product-list.jsp" />
                                                <input type="submit" class="btn btn-outline-light" name="action" value="View Details Cake" />
                                                <input type="submit" class="btn btn-outline-danger" value="Delete Cake Admin" name="action"/>
                                            </div>
                                        </div>
                                    </div>
                                                </form>
